        ...
        for simple in (False, True):
            with self.subTest(simple=simple):
                ...
                if simple:
                    ...
                    self.assertNotIn('imagetools', log)
                    # Exact release version only — no floating tags.
                    ...
                    # Exact release version only — no floating tags.
                    self.assertIn('fixturehub/sub2api:9.8.7', log)
                    self.assertIn('ghcr.io/exampleowner/sub2api:9.8.7', log)
                    self.assertNotIn('fixturehub/sub2api:9.8 ', log)
                    self.assertNotIn('ghcr.io/exampleowner/sub2api:9 ', log)
